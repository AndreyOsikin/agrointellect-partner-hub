/* Final calculator behavior — price labels + integration toggle */
(function(){
  if(window.__partnerCalculatorFinal)return;window.__partnerCalculatorFinal=true;
  ...
  function mount(){updateProducts();mountIntegration()}
  const obs=new MutationObserver(()=>requestAnimationFrame(mount));obs.observe(document.documentElement,{subtree:true,childList:true});
